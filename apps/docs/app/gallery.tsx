...
<Button tone="danger">Delete account</Button>`,
  ...
  {
    name: 'StatBlock', slug: 'stat-block',
...
/>`,
  ...
  secondary="227 400"
/>`,
    demo: (<div className="w-full max-w-[520px]">
  ...
  <StatBlock size="l" value="227 400" unit="XAF" />
    ...
    demo: (<div className="grid grid-cols-2 gap-gap-tile w-full max-w-[520px]">
...
<MeterBar segments={[
  ...
  { label: 'Bills', amount: 142000, color: 'var(--a-blue)' },
    ...
    demo: (<div className="w-full max-w-[440px] grid gap-s9">
...
<Field label="Amount" size="lg" prefix="XAF" value="250 000" />`,
    demo: (<div className="w-full max-w-[360px] grid gap-s9">
      <Field label="Account name" value="MTN MoMo — 677 04" hint="The number the salary lands on." />
      <Field label="Amount" size="lg" prefix="XAF" value="250 000" />
    </div>),
  },
  {
    name: 'SelectDisplay', slug: 'select-display',
  ...
  meta="3 this month"
/>`,
    demo: <div className="w-full max-w-[360px]"><SelectDisplay label="Category" value="School fees" dot="var(--a-coral)" meta="3 this month" /></div>,
  },
  {
...
/>`,
    demo: (<div className="w-full max-w-[440px]">
  ...
  {
    name: 'SegmentedTabs', slug: 'segmented-tabs',
