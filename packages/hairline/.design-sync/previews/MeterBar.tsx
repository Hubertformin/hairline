import { MeterBar } from '@hairline/ds';

/** A limit meter, under and over the ceiling. */
export const Limit = () => (
  <div style={{ width: 420, display: 'grid', gap: 22 }}>
    <div>
      <div className="hl-label" style={{ marginBottom: 10 }}>Under the ceiling</div>
      <MeterBar value={62} limit={100} />
    </div>
    <div>
      <div className="hl-label" style={{ marginBottom: 10 }}>Over the ceiling</div>
...
export const Composition = () => (
  <div style={{ width: 420 }}>
    <div className="hl-label" style={{ marginBottom: 10 }}>Where it went</div>
    <MeterBar
      segments={[
